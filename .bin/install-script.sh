...
sudo pacman -S --noconfirm --needed base-devel xorg-server xorg-xinit xcompmgr xdotool openbox nitrogen rxvt-unicode tmux nautilus ttf-font-awesome ttf-ubuntu-font-family ttf-hack lxappearance firefox eog tint2 lightdm light-locker
